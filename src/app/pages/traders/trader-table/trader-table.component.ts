...
const global_router_add_url_in_Table = '/trader/add';
const global_router_view_url = '/trader/view';
const global_router_edit_url = '/trader/edit';
...
export class TraderTableComponent {
  ...
  displayTableCols(currentLang: string) {
    this.columns = [
      ...
      {
        keyName: 'email',
        header: this.languageService.translate('trader.form.email'),
        type: EType.text,
        show: true,
      },
      {
        keyName: 'phone',
        header: this.languageService.translate('trader.form.phone'),
        type: EType.text,
        show: true,
      },
      {
