...
function mapPaginationParams(
  ...
  if (out['sortingDirection'] !== undefined) {
    out['sortDirection'] =
      out['sortingDirection'] === 1 || out['sortingDirection'] === '1'
        ? 'desc'
        : 'asc';
    delete out['sortingDirection'];
  }
  if (
    out['enName'] !== undefined ||
    out['arName'] !== undefined ||
    out['titleEn'] !== undefined ||
    out['titleAr'] !== undefined ||
    out['enTitle'] !== undefined ||
    out['arTitle'] !== undefined ||
    out['searchTerm'] !== undefined
  ) {
    out['searchTerm'] =
      out['searchTerm'] ||
      out['enName'] ||
