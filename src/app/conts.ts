...
export const menuItems  : MenuItem[] =
  [
    ...
    { icon: 'pi pi-wallet', id:'financial',label: 'side_bar.financial_reports', route: '/financial-reports',type:[Roles.admin]  },
    { icon: 'pi pi-money-bill', id:'settlements',label: 'side_bar.settlements', route: '/settlements',type:[Roles.admin]  },
    { icon: 'pi pi-percentage', id:'commission',label: 'side_bar.commission', route: '/commission-settings',type:[Roles.admin]  },
    { icon: 'pi pi-id-card', id:'wallet_management',label: 'side_bar.wallet_management', route: '/wallet-management',type:[Roles.admin]  },
    { icon: 'pi pi-chart-line', id:'trader_financial',label: 'side_bar.trader_financial', route: '/trader-financial',type:[Roles.trader]  },
    ...
    { icon: 'pi pi-user', id:'clients',label: 'side_bar.clients', route: '/clients',type:[Roles.admin]  },
